...
> {
  ...
  static defaultProps: DraggableCoreDefaultProps = {
    ...
    scale: 1,
    onCancelDragStart: function () {},
    onCancelDragEnd: function () {}
  };
  ...
  onPartDragStartFn = this.onPartDragStart.bind(this);

  onPartDragEndFn = this.onPartDragEnd.bind(this);
  ...
  handleDragStart: EventHandler<MouseTouchEvent> = e => {
    ...
    if (
      ...
      this.props.cancel &&
        this.props.cancel.replace(".react-resizable-handle,", "") &&
        console.log("gridItem drag start 命中cancel");
      // this.props.onCancelDragStart(e);
      return;
    }
  ...
  handleDrag: EventHandler<MouseTouchEvent> = e => {
    ...
    // 取消标识命中
    const thisNode = this.findDOMNode();
    const useCancel = this.props.cancel
      ? this.props.cancel.replace(".react-resizable-handle,", "")
      : "";
    if (
      !this.props.disabled &&
      ...
      // e["target"] &&
      // thisNode &&
      matchesSelectorAndParentsTo(e["target"], useCancel, thisNode)
    ) {
      console.log("gridItem drag 命中cancel");
      return;
    }
  ...
  handleDragStop: EventHandler<MouseTouchEvent> = e => {
    ...
    if (
      ...
      console.log("gridItem dragStop 命中cancel");
      // this.props.onCancelDragEnd(e);
      return;
    }
  ...
  onPartDragStart(e) {
    ...
    if (
      ...
      e.dataTransfer.setData(
        DRAG_GRID_ITEM_TYPE,
        JSON.stringify({ targetType: "cancel" })
      );
      this.props.onCancelDragStart(e);
  ...
  onPartDragEnd(e) {
    ...
    if (
      ...
      console.log("clear dataTransfer");
      e.dataTransfer.clearData(DRAG_GRID_ITEM_TYPE);
      this.props.onCancelDragEnd(e);
      // e.nativeEvent.stopImmediatePropagation();
    }
    e.stopPropagation();
  ...
  render(): React.Element<any> {
    ...
    return React.cloneElement(React.Children.only(this.props.children), {
      ...
      onDragStart: this.onPartDragStartFn,
      onDragEnd: this.onPartDragEndFn
    });
  }
}
